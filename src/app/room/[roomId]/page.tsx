    ...
    <div class="main-col">
      ...
      <div class="video-wrap" id="videoWrap" style="background:transparent !important; overflow:visible;">
        ...
        <div id="ytPlayerContainer" style="display:none; width:100%; height:100%; position:relative; z-index:6; min-height:360px; border-radius:20px; overflow:hidden; background:#000;">
          ...
          <!-- Blocker to disable timeline scrubbing for viewers -->
          <div id="ytTimelineBlocker" style="display:none; position:absolute; bottom:30px; left:0; width:100%; height:25px; z-index:999999; background:transparent; cursor:not-allowed;" onclick="event.stopPropagation();" onmousedown="event.stopPropagation();" onmouseup="event.stopPropagation();" ontouchstart="event.stopPropagation();" ontouchend="event.stopPropagation();"></div>
        </div>
      ...
      <div class="panel-content" id="contentPeople" style="flex-direction:column; height:100%;">
        ...
        <div class="people-wrap" id="peopleList" style="flex:1; overflow-y:auto; padding:12px 16px;">
          <div class="ppl-empty">
